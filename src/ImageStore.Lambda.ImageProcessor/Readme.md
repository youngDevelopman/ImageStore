...
Execute unit tests
```
    cd "ImageStore.Lambda.ImageProcessor/test/ImageStore.Lambda.ImageProcessor.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "ImageStore.Lambda.ImageProcessor/src/ImageStore.Lambda.ImageProcessor"
